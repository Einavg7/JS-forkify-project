...
3. Improve recipe ingredient input: separate in multiple ingredients for each recipe (not only 6)
...
6. Get nutrition data on each ingredient from spoonacular API and calculate total calories of recipe.
*/